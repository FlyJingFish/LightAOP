...
import com.flyjingfish.lightaop.logger.XLogger;
...
public class DebugLogAspectJ {
    ...
    public Object logAndExecute(ProceedingJoinPoint joinPoint, DebugLog debugLog1) throws Throwable {
        enterMethod(joinPoint, debugLog1);
        ...
        exitMethod(joinPoint, debugLog1, result, lengthMillis);
     ...
     * @param joinPoint
     */
    private void enterMethod(ProceedingJoinPoint joinPoint, DebugLog debugLog1) {
        if (!XLogger.isDebug()) {
            return;
        }
        ...
        XLogger.log(debugLog1.priority(), Utils.getClassName(cls), builder.toString());
     ...
     */
    private void exitMethod(ProceedingJoinPoint joinPoint, DebugLog debugLog1, Object result, long lengthMillis) {
        if (!XLogger.isDebug()) {
            return;
        }
