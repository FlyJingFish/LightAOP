 ...
 */
package com.flyjingfish.light_aop_plugin.internal.cache

import com.android.builder.model.AndroidProject
import com.flyjingfish.light_aop_plugin.AJXExtension
import com.flyjingfish.light_aop_plugin.internal.AJXUtils
import com.flyjingfish.light_aop_plugin.internal.model.AJXExtensionConfig
...
class AJXCache {
    ...
    private void init() {
        ...
        if (extensionConfig.exists()) {
            ajxExtensionConfig = AJXUtils.optFromJsonString(FileUtils.readFileToString(extensionConfig, Charset.defaultCharset()), AJXExtensionConfig.class)
        }
