...
object LightAop {
    ...
    /**
     * 如果你使用了 [com.flyjingfish.light_aop_core.annotations.TryCatch], 设置此项可以拿到异常回调
     */
    ...
    /**
     * 如果你使用了 [com.flyjingfish.light_aop_core.annotations.CustomIntercept] ,设置此项可以拿到自定义拦截回调
     */
    ...
    /**
     * 如果你使用了 [com.flyjingfish.light_aop_core.annotations.Permission], 设置此项才可以请求权限
     */
